<?php
/**
 * Template that outputs some marketing/CTA blurb about the app.
 *
...
<div class="gwf-app-cta wp-block-group alignfull mt-0 mb-0">
	<div class="wp-block-group__inner-container" style="margin-bottom: 0;">
		...
		<p class="gwf-app-cta__intro">Here's how you can speed up the transition to a greener internet.</p>
		...
		<div class="gwf-app-cta__ctas wp-block-gwf__threecols-t-p-b">
			...
			<p class="gwf__threecols-t-p-b__para">Help sustain this work as an open source project in service to the public’s interest.</p>
			...
			<p class="gwf__threecols-t-p-b__para">When you cite us publicly, it helps more people discover this work and take action.</p>
